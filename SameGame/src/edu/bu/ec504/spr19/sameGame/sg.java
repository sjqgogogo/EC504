...
import edu.bu.ec504.spr19.Brain.*;
...
class sg extends GUI implements ActionListener,ItemListener {
	...
	private JRadioButtonMenuItem noPlayerMenuItem,simplePlayerMenuItem, lazyPlayerMenuItem, // various automatic player options
		smarterPlayerMenuItem, greedyPlayerMenuItem, sjqPlayerMenuItem;
	...
	void setupGUI() {
		...
		greedyPlayerMenuItem = new JRadioButtonMenuItem("sjq Greedy player");
		greedyPlayerMenuItem.addItemListener(this);
		group.add(greedyPlayerMenuItem);
		menu.add(greedyPlayerMenuItem);


		sjqPlayerMenuItem = new JRadioButtonMenuItem("sjq player");
		sjqPlayerMenuItem.addItemListener(this);
		group.add(sjqPlayerMenuItem);
		menu.add(sjqPlayerMenuItem);
	...
	public void itemStateChanged(ItemEvent e) {
		...
		if (e.getStateChange() == ItemEvent.SELECTED) {
			...
			else if (source == greedyPlayerMenuItem)
				startBrain(new greedyBrain(this));
			else if (source == sjqPlayerMenuItem)
				startBrain(new sjqBrain(this));
/*
